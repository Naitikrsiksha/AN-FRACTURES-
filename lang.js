...
const TRANSLATIONS = {
  ...
  med_sub:         { en: 'Doorstep delivery — ₹4.34/km charge', hi: 'घर पर डिलीवरी — ₹4.34/किमी शुल्क' },
  med_banner_h:    { en: 'Home Delivery Available — ₹4.34 per km charge', hi: 'घर डिलीवरी उपलब्ध — ₹4.34 प्रति किमी शुल्क' },
  ...
  med_notice:      { en: '₹4.34 per km delivery charge applies (within serviceable area).',
                     hi: '₹4.34 प्रति किमी डिलीवरी शुल्क लागू (सेवा योग्य क्षेत्र के भीतर)।' },
  ...
  med_distance:    { en: 'Distance from Clinic (km)',     hi: 'क्लिनिक से दूरी (किमी)' },
  ...
  med_charge_lbl:  { en: 'Estimated Delivery Charge',     hi: 'अनुमानित डिलीवरी शुल्क' },
  med_img_lbl:     { en: 'Prescription Image (Optional)', hi: 'पर्ची की तस्वीर (वैकल्पिक)' },
  med_img_btn:     { en: 'Upload Prescription Image',     hi: 'पर्ची की तस्वीर अपलोड करें' },
  med_img_hint:    { en: 'Upload a clear photo of your prescription (JPG/PNG, max 5MB)',
                     hi: 'अपनी पर्ची का साफ़ फोटो अपलोड करें (JPG/PNG, अधिकतम 5MB)' },
